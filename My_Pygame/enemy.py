...
# ====================Define the special enemy behaviors====================
class SpEnemy(pygame.sprite.Sprite, Enemy):
    ...
    def __init__(self, bg_size):
        ...
        self.bg_width, self.bg_height = bg_size[0], bg_size[1]
        self.speed = 5
        self.energy = self.sp_enemy_energy
    ...
    def reset(self):  # When moving down out of the screen
        ...
        self.active = False
        self.hit = False
        self.energy = SpEnemy.sp_enemy_energy
        # self.supply()
